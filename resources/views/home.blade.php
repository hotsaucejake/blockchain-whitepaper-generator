                ...
                <div class="col-xs-12 col-sm-12 col-lg-12 mx-auto">
                      ...
                      <div class="form-check">
                          <label class="form-check-label">
                            <input class="form-check-input" type="checkbox" id="bitcoin" value="bitcoin" checked=""> <strong>Bitcoin:</strong> A Peer-to-Peer Electronic Cash System
                          </label>
                     </div>
                     <div class="form-check">
                         <label class="form-check-label">
                           <input class="form-check-input" type="checkbox" id="lightning" value="lightning"> <strong>The Bitcoin Lightning Network:</strong> Scalable Off-Chain Instant Payments
                         </label>
                    </div>
                    <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="checkbox" id="tumblebit" value="tumblebit"> <strong>TumbleBit:</strong> An Untrusted Bitcoin-Compatible Anonymous Payment Hub
                        </label>
                   </div>
                     <div class="form-check">
                          <label class="form-check-label">
                            <input class="form-check-input" type="checkbox" id="ethereum" value="ethereum"> <strong>Ethereum:</strong> A Secure Decentralised Generalised Transaction Ledger
                          </label>
                     </div>
                     <div class="form-check">
                          <label class="form-check-label">
                            <input class="form-check-input" type="checkbox" id="cryptonote" value="cryptonote"> <strong>CryptoNote</strong> v 2.0
                          </label>
                     </div>
                     <div class="form-check">
                          <label class="form-check-label">
                            <input class="form-check-input" type="checkbox" id="mimblewimble" value="mimble"> <strong>MimbleWimble</strong>
                          </label>
                     </div>
                     <div class="form-check">
                          <label class="form-check-label">
                            <input class="form-check-input" type="checkbox" id="enigma" value="enigma"> <strong>Enigma:</strong> Decentralized Computation Platform with Guaranteed Privacy
                          </label>
                     </div>
